pipeline {
    ...
    environment {
        ...
        AWS_ACCOUNT_ID="046234828860"
        AWS_DEFAULT_REGION="us-east-1"
        IMAGE_REPO_NAME="jenkins-pipeline"
        IMAGE_TAG= "${env.BUILD_ID}"
        REPOSITORY_URI = "046234828860.dkr.ecr.us-east-1.amazonaws.com/jenkins-pipeline"
    }
    stages {
        stage('Git checkout') {
            steps {
                git 'https://github.com/Nne-Bentoro/realone-repo.git'
            }
        }
